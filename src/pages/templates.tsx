    ...
    <div className="space-y-8">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <button onClick={testBasicAPI} className="bg-blue-500 text-white px-4 py-2 rounded">
            Test Basic API
          </button>
          <button onClick={testSupabaseConnection} className="bg-green-500 text-white px-4 py-2 rounded">
            Test Supabase
          </button>
          <button onClick={fetchTemplates} className="bg-purple-500 text-white px-4 py-2 rounded">
