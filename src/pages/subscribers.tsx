// src/pages/subscribers.tsx - Responsive version
    ...
    <div className="space-y-6 lg:space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200 text-center sm:text-left">
          <div className="text-xl lg:text-2xl font-bold text-purple-600">{uploadedCount.toLocaleString()}</div>
      ...
      {preview.length > 0 && (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="p-4 lg:p-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <h2 className="text-lg lg:text-xl font-semibold text-gray-900">Preview</h2>
